...
public:
    ...
    // Method untuk menambahkan daftar film
    void tambahdata(int n);
    
    // Method untuk menghapus daftar film
...
//tambah data film
void DatabaseFilm::tambahdata(int n) {
for(int i = 0; i < n; i++){
...
{
std::ofstream file("film.txt", std::ofstream::trunc); // Membuka file dengan mode truncating untuk menghapus semua data
